...
(図\ref{fig:tasuki-gake} and \ref{fig:tasuki-gake-picture})。
...
This structure makes visible the richness of expressive function and practical use that goes beyond a simple binary model.(Figure \ref{fig:tasuki-gake} and \ref{fig:tasuki-gake-picture}).
