...
\ifJPN
  \textbf{即時文法は、会話分析やディスコース分析のような録音・文字化・分析の手続きを無視しているのですか？}
\else
  \textbf{Does Immediate Grammar ignore the procedures of recording, transcription, and analysis like conversation analysis or discourse analysis?}
\fi
